            ...
            <div className="">
                <div className="relative">
                    ...
                    <div className="absolute bottom-0 left-0 pb-12 w-full">
                        <h1 className="text-display text-2xl md:text-4xl p-6 bg-gradient-to-r from-black to-black/0 text-white block">
                ...
                <div className="flex flex-wrap">
                    <div className="w-1/2 md:w-1/4 h-[25vh] relative">
                        ...
                        <h2 className="text-lg font-semibold font-sans p-2 bg-black/25 text-white w-full text-center backdrop-blur text-sm">Behind The Glass Gallery</h2>
                        </div>
                    </div>
                    <div className="w-1/2 md:w-1/4 h-[25vh] relative">
                        <img src="riser.jpg" className="object-cover h-full w-full" alt="Main Street Riser" />
                        <div className="absolute bottom-0 w-full flex items-center justify-center">
                        <h2 className="text-lg font-semibold font-sans p-2 bg-black/25 text-white w-full text-center backdrop-blur text-sm">Main Street Riser</h2>
                        </div>
                    </div>
                    <div className="w-1/2 md:w-1/4 h-[25vh] relative">
                        <img src="atrium2.jpg" className="object-cover h-full w-full" alt="North Atrium" />
                        <div className="absolute bottom-0 w-full flex items-center justify-center">
                        <h2 className="text-lg font-semibold font-sans p-2 bg-black/25 text-white w-full text-center backdrop-blur text-sm">North Atrium</h2>
                        </div>
                    </div>
                    <div className="w-1/2 md:w-1/4 h-[25vh] relative">
                        <img src="wedding2.jpg" className="object-cover h-full w-full" alt="The Full Mercantile On Main" />
                        <div className="absolute bottom-0 w-full flex items-center justify-center">
                        <h2 className="text-lg font-semibold font-sans p-2 bg-black/25 text-white w-full text-center backdrop-blur text-sm">The Full Mercantile</h2>
                        </div>
                    </div>
                </div>
